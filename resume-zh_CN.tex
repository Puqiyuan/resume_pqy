...
\datedsubsection{\textbf{龙芯中科} 北京}{2021年3月 -- 2023年3月}
\role{内核开发工程师}{}
\begin{onehalfspacing}
...
\datedsubsection{\textbf{EasyStack} 成都}{2023年3月 -- 至今}
\role{内核开发工程师}{}
\begin{onehalfspacing}
  ...
  \item 其它一些各种各样的内核问题。对内核故障排查具有较为丰富的经验，熟练使用crash分析
    vmcore，反汇编/汇编分析，熟悉kporbe、stap脚本调试内核。推内核栈等基本就是日常工作。由于处理各种类型内核的故障，而故
